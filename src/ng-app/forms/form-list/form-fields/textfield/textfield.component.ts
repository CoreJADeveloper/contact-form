...
export class TextFieldViewComponent {
    ...
    open_settings_dialog(){
        let dialogRef = this.dialog.open(TextfieldSettingsDialog, {
            width: '450px',
...
@Component({
    selector: 'textfield-settings-dialog',
    templateUrl: 'textfield-settings-dialog.html',
})
export class TextfieldSettingsDialog {

    constructor(
        public dialogRef: MdDialogRef<TextfieldSettingsDialog>,
