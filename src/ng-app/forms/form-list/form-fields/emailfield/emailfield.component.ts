...
export class EmailFieldViewComponent {
    ...
    open_settings_dialog(){
        let dialogRef = this.dialog.open(EmailfieldSettingsDialog, {
            width: '450px',
...
@Component({
    selector: 'emailfield-settings-dialog',
    templateUrl: 'emailfield-settings-dialog.html',
})
export class EmailfieldSettingsDialog {

    constructor(
        public dialogRef: MdDialogRef<EmailfieldSettingsDialog>,
